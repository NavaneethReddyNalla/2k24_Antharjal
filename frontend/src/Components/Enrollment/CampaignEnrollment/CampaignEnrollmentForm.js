  ...
  return (
    <div>
        ...
        <div className='row mb-2'>
            ...
            <div>
            <label htmlFor="age" className='mb-2 mx-2 form-label'>Mobile Number</label>

            <input type="tel" placeholder="Mobile number" {...register("Mobile number", {required: true})} />

        </div>
        <div>
            <label htmlFor="age" className='mb-2 mx-2 form-label'>Email</label>

            <input type="text" placeholder="Email" {...register("Email", {required: true, pattern: /^\S+@\S+$/i})} />

        </div>
        <div>
            <label htmlFor="age" className='mb-2 mx-2 form-label'>Blood Group</label>
        ...
        <div>
        <label htmlFor="age" className='mb-2 mx-2 form-label'>Patient RoomNo</label>
        ...
        <div>
            ...
            <input type="datetime" placeholder="Deadline" {...register("Deadline for Collecting Funds", {required: true})} />
