...
export default function CampaignEnrollmentForm() {
  ...
  return (
    <div>
        ...
        <div>
            <label htmlFor="age" className='mb-1 mx-2 form-label'>Campaign Title</label>
        ...
        <div className='row mb-3'>
            ...
            <div className='col-xs-1 col-6 mb-3'>
            <label htmlFor="lastname" className='mb-1 mx-2 form-label'>LastName</label>
        ...
        <div>
        <label htmlFor="age" className='mb-2 mx-2 form-label'>Patient Room Number</label>
        ...
        <div>
            <label htmlFor="age" className='mb-2 mx-2 form-label'>Deadline for Funding</label>
